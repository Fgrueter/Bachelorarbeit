...
class LoggerOutputs:
    ...
    def addScore(self, score, run):
       ...
       #                show_legend = True)
        ...
        # if mean_score >= AVERAGE_SCORE_TO_SOLVE or len(self.scores) >= CONSECUTIVE_RUNS_TO_SOLVE: # Solution Found
